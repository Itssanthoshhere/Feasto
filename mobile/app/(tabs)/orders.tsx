...
export default function OrdersScreen() {
  const { fetchCart, reorderItems } = useAppData();
            ...
            {!loading && orders.length > 0 && (
              <View className="flex-row gap-3 mb-4">
                {[
                  ...
                  <View
                    key={s.label}
                    className="flex-1 rounded-2xl p-3 border border-slate-100"
              ...
              {(["active", "completed"] as Tab[]).map((tab) => {
                ...
                return (
                  ...
                  >
                    ...
                    <View
                      className={`rounded-full w-5 h-5 items-center justify-center ${isActive ? "bg-[#FF5A1F]" : "bg-slate-100"}`}
                    >
                      <Text
            ...
            >
              ...
              <View className="p-4 flex-row items-center gap-3">
                ...
                <View className="flex-1 min-w-0">
                  <View className="flex-row items-center justify-between">
                    <Text
                      className="text-base text-slate-900 flex-1 mr-2"
                      numberOfLines={1}
                      style={{ fontFamily: "Outfit_700Bold" }}
                    >
